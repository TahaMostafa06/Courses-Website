...
public class ManageLessonsTab extends javax.swing.JPanel {
    ...
    public void updateLessonView(Instructor instructor, CourseItem courseItem) {
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_saveButtonActionPerformed
        if (!lessonList.isSelectionEmpty()) {
            ...
            instructor.setLessonTitle(courseItem, lesson, lessonTitleInputField.getText());
            instructor.setLessonContent(courseItem, lesson, contentInputField.getText());
            instructor.setLessonAdditionalResources(courseItem, lesson, additionalResourcesInputField.getText());
            updateEditingSpace(true);
            instructorLessonListModel.update();
        } else {
            var newLesson = instructor.addLesson(courseItem, lessonTitleInputField.getText(),
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_deleteButtonActionPerformed
        if (!lessonList.isSelectionEmpty()) {
            var lesson = lessonList.getSelectedValue();
            instructor.removeLesson(courseItem, lesson);
            instructorLessonListModel.update();
            updateEditingSpace(false);
        }
