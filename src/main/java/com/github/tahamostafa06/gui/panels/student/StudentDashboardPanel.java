...
public class StudentDashboardPanel extends CardPanel {
    ...
    private com.github.tahamostafa06.gui.panels.student.Insights insights1;
    ...
    private com.github.tahamostafa06.gui.panels.student.ViewCertificates viewCertificates;
    ...
    public static void showCertificate(CourseItem selectedCourseItem) {
        var tabManager = instance.dashboardTabbedPane;
        instance.viewLessonsTab.updateLessonView(instance.student, selectedCourseItem);
    ...
    private void initComponents() {
        ...
        viewCertificates = new com.github.tahamostafa06.gui.panels.student.ViewCertificates();
        insights1 = new com.github.tahamostafa06.gui.panels.student.Insights();
        ...
        dashboardTabbedPane.addTab("View Certificate", viewCertificates);
        dashboardTabbedPane.addTab("tab6", insights1);
